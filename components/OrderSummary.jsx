...
const OrderSummary = () => {
  const { user, cartItems, products, currency, router, getCartCount, getCartAmount, setCartItems } = useAppContext();
  ...
  return (
    <div className="w-full md:w-96 bg-gray-500/5 p-5">
      ...
      <button
        ...
        disabled={placingOrder || getCartCount() === 0}
        className={`w-full py-3 mt-5 text-white ${
          placingOrder || getCartCount() === 0 ? "bg-gray-400 cursor-not-allowed" : "bg-orange-600 hover:bg-orange-700"
        }`}
      >
